export const products = [
  {
    ...
    shortDescription: "A stylish, slim-fit cotton shirt perfect for casual and semi-formal occasions.",
  ...
  },
  {
    id: 5,
    name: "Men's Sneakers",
    shortDescription: "Durable, stylish sneakers ideal for casual and active lifestyles.",
  ...
  },
  {
    ...
    longDescription: "Add a touch of luxury to your daily essentials with this Women's Leather Handbag. Crafted from premium leather with a polyester lining and sturdy metal hardware, this handbag combines durability with timeless elegance. Its spacious interior offers ample room for essentials like a wallet, phone, and makeup, while additional compartments ensure organized storage. Available in Brown, Black, and Grey, the bag features a sleek design with a secure zipper closure and comfortable handles, making it ideal for work, travel, or casual outings. The high-quality leather is resistant to wear and easy to clean, ensuring long-lasting beauty. Perfect for the modern woman, this handbag effortlessly elevates any outfit, from casual jeans to professional attire.",
    price: 3000,
    discount: 20,
    category: "womens fashion",
    isNewArrival: false,
  ...
  },
  {
    ...
    shortDescription: "Polished leather shoes for sophisticated formal occasions.",
  ...
  },
  {
    ...
    longDescription: "Enhance your outfit with this Women's Scarf, a soft and stylish accessory perfect for any season. Made from a blend of cotton, polyester, and viscose, this scarf offers a lightweight, comfortable feel that drapes beautifully. Available in Blue, Red, and Grey, its versatile design complements both casual and formal looks, from cozy sweaters to elegant coats. The breathable fabric is gentle on the skin, making it ideal for all-day wear, while the vibrant colors add a pop of style to any ensemble. Perfect for layering in cooler weather or adding flair to a summer outfit, this scarf is a must-have accessory for the fashion-forward woman.",
    price: 600,
    discount: 5,
    category: "womens fashion",
    isNewArrival: true,
  ...
  },
  {
    id: 17,
    name: "Men's Watch",
    shortDescription: "A sleek analog watch with a leather strap for timeless elegance.",
    ...
    isNewArrival: true,
    hasDiscount: true,
    materials: ["Leather (strap)", "Stainless Steel (case)", "Glass (crystal)", "Quartz"],
    images: {
      primary: "https://i.ibb.co/B2TRtrZP/noimage.png",
      detail: [
        "https://i.ibb.co/B2TRtrZP/noimage.png",
